    ...
    <>
      ...
      <div className="relative max-w-[1200px] mx-auto h-[500px] rounded-xl overflow-hidden mt-6">
        ...
        <div className="absolute inset-0 flex flex-col justify-center px-6 sm:px-12">
          <h1 className="text-[#003f87] text-5xl sm:text-6xl md:text-8xl font-bold">Cultural Council</h1>
          <p className="text-[#003f87] text-3xl sm:text-4xl md:text-5xl font-semibold mt-2">IIT Jammu</p>
        </div>
      </div>
      ...
      <section className="bg-blue-50 mt-20 py-16">
        <h2 className="text-center text-4xl font-bold text-[#003f87] mb-12">Our Clubs</h2>
