...
export default function Page() {
  ...
  return (
    <>
      ...
      {/* Secretary */}
      <div className="max-w-sm mx-auto py-16 mt-16 bg-blue-50 rounded-xl shadow-md flex flex-col items-center px-6">
        ...
        <h2 className="text-3xl font-bold text-[#003f87]">{secretary.name}</h2>
